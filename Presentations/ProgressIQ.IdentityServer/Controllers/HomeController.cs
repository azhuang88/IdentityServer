    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult AppIntegration()
        {
            ...
            if (Configuration.FederationMetadata.Enabled)
            {
                ...
                list.Add("WS-Federation metadata (AZ)", endpoints.WSFederationAZMetadata.AbsoluteUri);
            }
            ...
            if (Configuration.WSFederation.Enabled)
            {
                ...
                if (Configuration.WSFederation.EnableFederation)
                {
                    ...
                    list.Add("WS-Federation AZ", endpoints.WSFederationAZ.AbsoluteUri);
        ...
        {
            ViewBag.Message = "ProgressIQ Identity Server.";
        ...
        {
            ViewBag.Message = "support@progressiq.com";
