...
namespace IdentityServer
{
    ...
    {
        private static readonly TraceSource _ts = new TraceSource("IdentityServer");
        ...
        [DebuggerStepThrough]
        public static void ErrorVerbose(string message, [CallerMemberName] string memberName = "",
