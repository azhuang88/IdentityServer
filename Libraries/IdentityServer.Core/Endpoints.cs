...
namespace IdentityServer
{
    ...
    public class Endpoints
    {
        ...
        public Uri WSFederationAZ { get; set; }
        public Uri LdapSignInUri { get; set; }
        public Uri WSFederationMetadata { get; set; }
        public Uri WSFederationRPMetadata { get; set; }
        public Uri WSFederationAZMetadata { get; set; }
        ...
        public static class Paths
        {
            ...
            public const string WSFedAZ = "issue/atoz";
            public const string LdapSignIn = "signin/atoz";
            ...
            public const string WSFedAZMetadata = "FederationMetadataAZ/2007-06/FederationMetadata.xml";
