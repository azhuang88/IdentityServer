...
namespace IdentityServer.TokenService
{
    ...
    public class TokenServiceConfiguration : SecurityTokenServiceConfiguration
    {
        ...
        private static readonly Lazy<TokenServiceConfiguration> _configuration = new Lazy<TokenServiceConfiguration>();
        ...
        public TokenServiceConfiguration()
        {
            ...
            if (ConfigurationRepository.WSTrust.EnableDelegation)
            {
                ...
                try
                {
                    ...
                    actAsRegistry.AddTrustedIssuer(ConfigurationRepository.Keys.SigningCertificate.Thumbprint,
