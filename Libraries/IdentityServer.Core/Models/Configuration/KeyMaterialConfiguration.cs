...
namespace IdentityServer.Models.Configuration
{
    ...
    {
        [Display(ResourceType = typeof (Core.Resources.Models.Configuration.KeyMaterialConfiguration),
            Name = "SigningCertificate", Description = "SigningCertificateDescription")]
        [Required]
        public X509Certificate2 SigningCertificate { get; set; }

        [Display(ResourceType = typeof (Core.Resources.Models.Configuration.KeyMaterialConfiguration),
            Name = "DecryptionCertificate", Description = "DecryptionCertificateDescription")]
        ...
        [Display(ResourceType = typeof (Core.Resources.Models.Configuration.KeyMaterialConfiguration),
            Name = "SymmetricSigningKey", Description = "SymmetricSigningKeyDescription")]
        [Required]
