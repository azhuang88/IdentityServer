...
namespace IdentityServer.Repositories.Sql
{
    public class ConfigurationDatabaseInitializer : CreateDatabaseIfNotExists<IdentityServerConfigurationContext>
    {
        public static void SeedContext(IdentityServerConfigurationContext context, bool loadTestData = false)
        {
            ...
            if (!context.Ldap.Any()) context.Ldap.Add(createDefaultLdapConfiguration());
            if (!context.WSTrust.Any()) context.WSTrust.Add(CreateDefaultWSTrustConfiguration());
            if (!context.FederationMetadata.Any())
            ...
            if (!context.AdfsIntegration.Any())
        ...
        private static GlobalConfiguration CreateDefaultGlobalConfiguration()
        {
            ...
            {
                SiteName = "ProgressIQ Identity Server",
                IssuerUri = "http://www.ProgressIQ.com/ls",
                IssuerContactEmail = "support@progressiq.com",
        ...
        private static LdapConfiguration createDefaultLdapConfiguration()
        {
        ...
        private static GlobalConfiguration CreateTestGlobalConfiguration()
        {
            ...
            {
                SiteName = "ProgressIQ Identity Server",
                IssuerUri = "http://www.ProgressIQ.com",
                IssuerContactEmail = "support@progressiq.com",
                DefaultWSTokenType = TokenTypes.Saml2TokenProfile11,
                DefaultHttpTokenType = TokenTypes.JsonWebToken,
                DefaultTokenLifetime = 10,
            ...
            return new List<IdentityProvider>
            {
                ...
                new IdentityProvider
                {
                    ...
                    WSFederationEndpoint =
                        "https://accounts.accesscontrol.windows.net/fe132fb5-4843-41b4-bce8-9366bad88b80/v2/wsfederation",
        ...
        private static List<Client> CreateTestClients()
        {
            return new List<Client>
            {
                new Client
                {
                    ...
                    RedirectUri =
                        "ms-app://s-1-15-2-756967155-51850-665164220-3494723435-3400456802-3915619528-546309680/",
                    ClientId = "test",
        ...
        private static List<OpenIdConnectClientEntity> CreateTestOpenIdConnectClients()
        {
            return new List<OpenIdConnectClientEntity>
            {
                new OpenIdConnectClientEntity
                {
                    ...
                    {
                        new OpenIdConnectClientRedirectUri
                        {
                            RedirectUri = "https://localhost/CodeFlowClient/oidccallback"
                        },
