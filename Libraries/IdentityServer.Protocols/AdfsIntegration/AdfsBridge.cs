...
namespace IdentityServer.Protocols.AdfsIntegration
{
    internal class AdfsBridge
    {
        private readonly IConfigurationRepository _configuration;
        private readonly SecurityTokenHandlerCollection _handler;
        ...
        public TokenResponse ConvertSamlToJwt(SecurityToken securityToken, string scope)
        {
            ...
            var descriptor = new SecurityTokenDescriptor
            {
                ...
                TokenIssuerName = _configuration.Global.IssuerUri,
                Lifetime =
                    new Lifetime(DateTime.UtcNow,
                        DateTime.UtcNow.AddMinutes(_configuration.AdfsIntegration.AuthenticationTokenLifetime))
            };
        ...
        private void StripSaml2ProtocolProperties(SecurityToken securityToken)
        {
                ...
                saml2Token.Assertion.Subject.SubjectConfirmations[0].SubjectConfirmationData != null)
            {
                ...
                var subjectConfirmationData =
                    saml2Token.Assertion.Subject.SubjectConfirmations[0].SubjectConfirmationData;
