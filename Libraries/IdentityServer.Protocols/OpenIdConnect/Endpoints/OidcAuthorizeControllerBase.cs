...
namespace IdentityServer.Protocols.OpenIdConnect
{
    ...
    public abstract class OidcAuthorizeControllerBase : Controller
    {
        ...
        {
            return new ClientErrorResult(new Uri(validatedRequest.RedirectUri), OAuth2Constants.Errors.AccessDenied,
                validatedRequest.ResponseType, validatedRequest.State);
        }
