...
namespace IdentityServer.Protocols
{
    public class AuthenticationHelper
    {
        ...
        public void SetSessionToken(string userName, string authenticationMethod, bool isPersistent, int ttl,
            IEnumerable<Claim> additionalClaims = null)
        {
        ...
        public bool TryGetClientCertificatePrincipalFromRequest(HttpRequestMessage request,
        ...
        public bool TryGetClientCertificateFromRequest(HttpRequestMessage request,
        ...
        public bool TryGetBasicAuthenticationPrincipalFromRequest(HttpRequestMessage request,
            out ClaimsPrincipal principal)
        {
            principal = null;
            HttpListenerBasicIdentity identity = null;
        ...
        public bool TryGetBasicAuthenticationCredentialsFromRequest(HttpRequestBase request,
            out HttpListenerBasicIdentity identity)
        {
            identity = null;

            var header = request.Headers["Authorization"] ?? request.Headers["X-Authorization"];
