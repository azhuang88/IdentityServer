...
using IdentityServer.Protocols.OpenIdConnect;
...
namespace IdentityServer.Protocols.OAuth2
{
    public static class Extensions
    {
        ...
        public static HttpResponseMessage CreateTokenResponse(this HttpRequestMessage request,
        ...
        public static ActionResult AuthorizeValidationError(this Controller controller,
            AuthorizeRequestValidationException exception)
        {
            ...
            if (clientException != null)
            {
                ...
                return new ClientErrorResult(clientException.RedirectUri, clientException.Error,
                    clientException.ResponseType, clientException.State);
            }
